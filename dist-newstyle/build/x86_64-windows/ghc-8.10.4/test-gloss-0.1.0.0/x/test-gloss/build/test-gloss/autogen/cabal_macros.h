...
/* package test-gloss-0.1.0.0 */
#ifndef VERSION_test_gloss
#define VERSION_test_gloss "0.1.0.0"
#endif /* VERSION_test_gloss */
#ifndef MIN_VERSION_test_gloss
#define MIN_VERSION_test_gloss(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_test_gloss */
...
#define CURRENT_COMPONENT_ID "test-gloss-0.1.0.0-inplace-test-gloss"
